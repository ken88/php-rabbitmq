...
$queueName = "task_queue2"; # 队列名
$exchangeName = 'task_exchange2'; # 交换机名字
$routeName = 'task_route2'; # 路由
...
$args->set('x-max-length', 5);  # 设置队列长度限制
$args->set('x-overflow', 'reject-publish-dlx');
$args->set('x-dead-letter-exchange', 'dl_size_exchange');  # 配置死信交换机
$args->set('x-dead-letter-routing-key', 'dl_size_route_key'); # 配置 Routing Key，路由到 dl_exchange
